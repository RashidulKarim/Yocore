...
export const httpStatusMap: Record<ErrorCode, number> = {
  ...
  [ErrorCode.TAX_PROFILE_NOT_FOUND]: 404,
  ...
  [ErrorCode.BILLING_PLAN_MEMBER_OVERFLOW]: 402,
  [ErrorCode.BILLING_PLAN_NOT_PUBLISHED]: 409,
  [ErrorCode.BILLING_REFUND_FAILED]: 502,
  [ErrorCode.BILLING_REFUND_INELIGIBLE]: 409,
  [ErrorCode.BILLING_SEAT_INVALID]: 422,
  [ErrorCode.BILLING_SUBSCRIPTION_NOT_ACTIVE]: 409,
  [ErrorCode.BILLING_SUBSCRIPTION_NOT_PAUSED]: 409,
  [ErrorCode.BILLING_SUBSCRIPTION_PAUSED]: 409,
  [ErrorCode.BILLING_TRIAL_INELIGIBLE]: 409,
  [ErrorCode.BILLING_USAGE_HARD_CAP_EXCEEDED]: 402,
  [ErrorCode.BILLING_GATEWAY_MIGRATION_INELIGIBLE]: 409,
  [ErrorCode.BILLING_TAX_ID_INVALID]: 422,
